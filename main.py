...
def main():
    ...
    address = FacilityAddress(
        city="Warszawa", street="Marszałkowska", street_number="1", post_code="00-001"
    )
    fac_contact = FacilityContact(
        email="rezerwacje@grandhotel.pl", website="https://www.grandhotel.pl"
    )
